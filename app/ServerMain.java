...
public class ServerMain {
    ...
    private static final String DATABASE_FILENAME = "kongfu.db";
    private static final int DISCONNECT_COUNTDOWN_SECONDS = 20;

    public static void main(String[] args) throws InterruptedException {
        new File(DATA_DIR).mkdirs();
        UserStore userStore = new UserStore("jdbc:sqlite:" + DATA_DIR + "/" + DATABASE_FILENAME);
        ActivityLog activityLog = new ActivityLog(DATA_DIR + "/" + ActivityLog.DEFAULT_FILENAME);
